...
(1, '127.0.0.1/votbem/admin/login', 'administrator', '$2y$12$d88xj0WgEOmJTcoe34Vao.aSEsdFWzk4c8HauQN3ZzFUHR5AnwlrC', 'admin@admin.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1268889823, 1575670561, 1, 'Administrator', 'Utama', 'ADMIN', '0');
