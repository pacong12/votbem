            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        ...
                        <a href="<?php echo base_url('admin/data_pemilih') ?>" class="small-box-footer">More info <i
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-yellow">
                        ...
                        <a href="<?php echo base_url('admin/kandidat') ?>" class="small-box-footer">More info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
...
$label = array();
$noUrut = array();
foreach ($kandidatDataDpm as $data) {
    $suara[] = $data['jumlahSuara'];
    $label[] = $data['nama'];
    $noUrut[] = $data['noUrut'];
}
